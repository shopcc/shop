...
<script type="text/javascript" src="<?php echo (RESOURCE); ?>/js/user.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo (RESOURCE); ?>/qq/images/qq.css" />
...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> 购物流程<code>&gt;</code> 结算中心 
</div>
</div>
<div class="blank"></div>
...
<div class="usBox clearfix">
  <div class="usBox_1 f_l">
    <div class="login_tab">
    <ul>
        <li class="active"><a href="<?php echo U('cart/cart_login');?>">用户登录</a></li>
        <li ><a href="<?php echo U('member/reg');?>">用户注册</a></li>
    </ul>
    </div>
   <form name="formLogin" action="<?php echo U('cart/cart_login');?>" method="post" onSubmit="return userLogin()">
  ...
  <div class="usTxt">
  <a href="http://bbs.ecmoban.com" title="ecshop模板堂论坛 ecshop资源下载第一站" target="_blank"><img alt="ecshop模板堂论坛 ecshop资源下载第一站" src="<?php echo (RESOURCE); ?>/images/ecmoban.jpg" /></a>   </div>
</div>
</div>
