...
console.log(Utils.isTel(frm.elements['mobile'].value));
  if (frm.elements['s_province'] && frm.elements['s_province'].value == 0)
  {
    err = true;
  ...
  if (frm.elements['s_city'] &&  frm.elements['s_city'].value == 0  &&  frm.elements['s_city'].length > 1)
  {
    err = true;
    msg.push(city_not_null);
  }

  if (frm.elements['s_county'] && frm.elements['s_county'].length > 1)
  {
    if (frm.elements['s_county'].value == 0)
    {
      err = true;
